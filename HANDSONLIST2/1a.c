...
/*Output with the signal handler:
After 10 seconds (if argument 1) or 10 milliseconds (if argument 2), the program will print "Timer expired!" and continue running until manually terminated.*/